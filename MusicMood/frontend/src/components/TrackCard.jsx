    ...
    return (
        <Col md={6} lg={4} className="mb-3">
            <Card className="shadow-sm border-0 h-100 hover-shadow"
                onClick={() => onPlay(track)} style={{ cursor: 'pointer' }}>
                <Card.Body className="d-flex align-items-center p-2">
                    <img src={album_image} style={{ width: 50, height: 50, borderRadius: 4 }} className="me-3" />
                    <div className="flex-grow-1 overflow-hidden">
                        <div className="small text-truncate fw-bold">{name_track}</div>
                     ...
                     <div className="d-flex gap-2">
                        ...
                        <Button variant="link" className={`p-1 ${isFavorite ? 'text-danger' : 'text-sacondary'}`}  
